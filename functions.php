...
switch ($RESULT_TYPE) {
    ...
    {
        $cars = array($car1);
    }else if($maxprice>=500000 && $maxprice<100000)

    {
        $cars = array($car1,$car2);
    }else if($maxprice>=1000000 && $maxprice<15000000)
    {
...
{
    return json_encode(["Honda","Renault","Ford","Tata","Mahindra","Audi","BMW"]);
} 
...
function yearMakeModel()
{
    ...
    $model=array("Tata"=>array("Tigor","Nexon","Safari","Harrier"),
...
{
    $cat1=array( "image"=>"hatchback.webp",
    "name"=>"Hatchback",
    "id"=>1,
    "fname"=>"hatchback"
    );
    $cat2=array("image"=>"suv.webp",
     "name"=>"XUV",
     "id"=>2,
     "fname"=>"xuv"
    );
    $cat3=array("image"=>"sedan.webp",
     "name"=>"Sedan",
     "id"=>3,
     "fname"=>"sedan"
    );
