...
<div style="display: flex; width: 100%; background-color:rgb(42, 46, 84); height:15%">
    ...
    <div class="navElement" style="text-align:center; width:20%"> <a href="index.php"> <img src="images/capture.PNG" alt="" style="width:150px; height:100px; margin-top:-25px"> </a> </div>


    <div class="navElement">Service</div>
    <div class="navElement">Home</div>
    <div class="navElement" style="width: 20%;">Featured Cars</div>
